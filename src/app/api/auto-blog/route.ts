...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!pendingKeyword) {
      ...
      This is Step 1 (Brainstorming). Generate a wide variety of Government Job Vacancies (from the LAST 72 HOURS), Exam Notifications, Admit Cards, Answer Keys, Results, Counselling/Merit Lists, Timetables/Syllabus, Free Laptop/Coaching Schemes, Internships, Scholarships, University Admissions/Results, School/College News, Career Courses (e.g. Best courses after 12th), Board Exam Updates, Technology trends, and Finance updates. 
    ...
    HOWEVER, if it is a real Upcoming Exam, an Expected Syllabus, an Ongoing Application, an Expected Result, a State Scholarship, a Board Exam update, an Answer Key, a Counselling/Merit List schedule, a Free Laptop/Coaching Scheme, an Internship, or a University Admission/Result, DO NOT ABORT! Provide research for it (mentioning it is expected/upcoming if applicable) so the writer can write an informative guide.
    ...
    2. IMPORTANT DATES: Application Start Date, Last Date, Fee Payment Last Date, Exam Date, Counselling Date, or Result Date (if any).
