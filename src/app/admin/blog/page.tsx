              ...
              <tr key={post.id} style={{ borderBottom: '1px solid var(--color-border)' }}>
                <td style={{ padding: '1rem 1.5rem' }}>
                  <div style={{ fontWeight: 600, color: 'var(--color-text-primary)', marginBottom: '0.25rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    {post.title}
                    {post.content?.includes('[LINK_NOT_AVAILABLE]') && (
                      <span style={{ fontSize: '0.65rem', color: '#ef4444', background: 'rgba(239, 68, 68, 0.1)', padding: '0.1rem 0.4rem', borderRadius: '4px', border: '1px solid rgba(239, 68, 68, 0.3)' }} title="This post has missing official/purchase links. Edit to fix.">
                        🚨 Missing Link
                      </span>
                    )}
                  </div>
